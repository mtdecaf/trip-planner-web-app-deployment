...
const Dashboard = (props) => {
  ...
  return (
    <div className={cx("dashboard")}>
      ...
      <div
        className={cx("dashboard__side-bar", 
          sideBarDisplay ? "" : "dashboard__element--hidden")}
      >
        <h1 className={cx("side-bar__title")}>Trips</h1>
        {/* add new tripcard */}
        <span onClick={toggleAddTrip} className={cx("side-bar__add-new")}>
          <img
            src="https://img.icons8.com/ios-glyphs/30/000000/plus-2-math.png"
            alt="add a trip button"
          />
        </span>
      ...
      <div
        className={cx("dashboard__side-bar-mobile",
          sideBarDisplayMobile ? "" : "dashboard__element--hidden", "dashboard__mobile-element")}
      >
        <h1 onClick={toggleDisplay}>Trips</h1>
      </div>
      <div
        className={`dashboard__content-mobile ${
          dashboardDisplayMobile ? "" : "dashboard__element--hidden"
        } dashboard__mobile-element`}
      >
